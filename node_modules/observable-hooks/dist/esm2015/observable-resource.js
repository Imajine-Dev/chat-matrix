...
export class ObservableResource {
    ...
    constructor(input$, isSuccess) {
        ...
        this.input$ = input$;
        this.subscription = input$.subscribe(this.handleNext, this.handleError, this.handleComplete);
    }
    read() {
        if (this.error) {
            throw this.error;
    ...
    reload(newInput$) {
        ...
        this.subscription = this.input$.subscribe(this.handleNext, this.handleError, this.handleComplete);
    }
    destroy() {
        this.subscription.unsubscribe();
