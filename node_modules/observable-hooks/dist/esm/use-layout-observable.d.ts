 ...
 */
export declare function useLayoutObservable<TOutupt>(init: () => Observable<TOutupt>): Observable<TOutupt>;
/**
 ...
 */
export declare function useLayoutObservable<TOutupt, TInputs extends Readonly<any[]>>(init: (inputs$: Observable<TInputs>) => Observable<TOutupt>, inputs: TInputs): Observable<TOutupt>;
