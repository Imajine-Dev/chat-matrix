 ...
 */
export declare function useObservable<TOutupt>(init: () => Observable<TOutupt>): Observable<TOutupt>;
/**
 ...
 */
export declare function useObservable<TOutupt, TInputs extends Readonly<any[]>>(init: (inputs$: Observable<TInputs>) => Observable<TOutupt>, inputs: TInputs): Observable<TOutupt>;
